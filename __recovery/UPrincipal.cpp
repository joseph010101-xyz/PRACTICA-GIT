...
void __fastcall TForm1::btnSumaClick(TObject *Sender)
{
	char resul='+';
	numero->SetN(numero->Ejercicio15(resul,StrToInt(NUM1->Text),StrToInt(NUM2->Text)));
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::btnRestaClick(TObject *Sender)
{
	char resul='-';
	numero->SetN(numero->Ejercicio15(resul,StrToInt(NUM1->Text),StrToInt(NUM2->Text)));
}
...
void __fastcall TForm1::btnMultiplicacionClick(TObject *Sender)
{
	char resul='*';
	numero->SetN(numero->Ejercicio15(resul,StrToInt(NUM1->Text),StrToInt(NUM2->Text)));
}
