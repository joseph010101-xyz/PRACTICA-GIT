...
__published:	// IDE-managed Components
	...
	void __fastcall btnSumaClick(TObject *Sender);
	void __fastcall btnIgualClick(TObject *Sender);
	void __fastcall btnRestaClick(TObject *Sender);
	void __fastcall btnMultiplicacionClick(TObject *Sender);
